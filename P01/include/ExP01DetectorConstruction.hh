...
class ExP01DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
     ...
     G4double GetChamberWidth()            {return fChamberWidth;};
     G4LogicalVolume* GetLogicChamber()    {return fLogicChamber;};
     G4VPhysicalVolume* GetPhysiChamber()  {return fPhysiChamber;};
     void SetTargetMaterial (G4String);
     void SetChamberMaterial(G4String);
     void SetMagField(G4double);
     	void doGasHeIsobMix(double frcHe, std::string matName, double pressure, double temperature);
  ...
  private:
     ...
     G4VPhysicalVolume* fPhysiTargetUpstream;   // pointer to the physical Target
     G4VPhysicalVolume* fPhysiTargetDownstream;   // pointer to the physical Target
     ...
     G4int    fNbOfChambersX;            // Nb of chambers in the tracker region
     G4int    fNbOfChambersY;            // Nb of chambers in the tracker region
